...
Download [aws-exporter-v3.0.4-RELEASE-full.jar](https://github.com/anthunt/aws-exporter/releases/download/v3.0.4-RELEASE/aws-exporter-v3.0.4-RELEASE-full.jar) to your local path and run install
```
