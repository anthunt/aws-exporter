...
1. Download [aws-exporter-v3.0.6-RELEASE.zip](https://github.com/anthunt/aws-exporter/releases/download/v3.0.6-RELEASE/aws-exporter-v3.0.6-RELEASE.zip) to your local path and run install
2. Unzip file
3. install jar - it will be download dependencies and make structures
```
$ java -jar aws-exporter-3.0.6-RELEASE-full.jar
```
...
<pre><code>
Your path -
          |- aws-exporter-3.0.6-RELEASE-full.jar
